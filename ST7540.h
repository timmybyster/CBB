...
#define TRIS_n_CD_PD            TRISAbits.TRISA4
#define ANSEL_n_CD_PD           ANSELAbits.ANSELA4
#define PORT_n_CD_PD            PORTAbits.RA4
#define LAT_n_CD_PD             LATAbits.LATA4

#define TRIS_REGnDATA           TRISCbits.TRISC1
#define PORT_REGnDATA           PORTCbits.RC1
#define LAT_REGnDATA            LATCbits.LATC1

#define TRIS_RXD                TRISCbits.TRISC0
#define PORT_RXD                PORTCbits.RC0
#define LAT_RXD                 LATCbits.LATC0

#define TRIS_TXD                TRISCbits.TRISC7
#define PORT_TXD                PORTCbits.RC7
#define LAT_TXD                 LATCbits.LATC7

#define TRIS_RXnTX              TRISCbits.TRISC6
#define PORT_RXnTX              PORTCbits.RC6
#define LAT_RXnTX               LATCbits.LATC6
...
#define TRIS_CLR_T_IOC          TRISAbits.TRISA5
#define ANSEL_CLR_T_IOC         ANSELAbits.ANSELA5
#define PORT_CLR_T_IOC          PORTAbits.RA5
#define LAT_CLR_T_IOC           LATAbits.LATA5

#define TRIS_SPI_UART          TRISCbits.TRISC5
#define LAT_SPI_UART           LATCbits.LATC5
#define PORT_SPI_UART          PORTCbits.RC5
